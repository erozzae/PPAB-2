...
public class MainActivity extends AppCompatActivity implements SimpleFragmen.OnFragmentInteractionListener{
    ...
    private void openFragment(){
        ...
        SimpleFragmen simpleFragment = SimpleFragmen.newInstance(mCurrentChoice);
    ...
    private void closeFragment(){
        ...
        SimpleFragmen simpleFragment = (SimpleFragmen) fragmentManager.findFragmentById(R.id.fragment_container);
